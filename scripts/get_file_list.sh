...
get_file_list.pl -keys 'path,filename' -cond trgsetupname=production_pAu200_2015,filename~st_physics,production=P16id,filetype=daq_reco_picoDst,storage!=HPSS -limit 0 -delim "/" | sed 's|^/home/starlib|root://xrdstar.rcf.bnl.gov:1095//home/starlib|g' > tmp.list



tail -n $nfiles tmp.list > runs_path_all.list
rm -f tmp.list 
