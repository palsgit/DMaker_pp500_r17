...
// Signal narrow window all p_T -----------------------------------------------------------------------------------------------------------------------------
    ...
    *r1 = 10*(*diff1);
    ...
    s1->GetYaxis()->SetRangeUser(0,370000);
    ...
    c1->SaveAs(Form("pp500_BEMC_Mass_narrow_all_pT.pdf"));
    c1->Close();
...
// Signal narrow window p_T 1-2 GeV-----------------------------------------------------------------------------------------------------------------------------
    ...
    *r2 = 10*(*diff2);
    ...
    s2->GetYaxis()->SetRangeUser(0,180000);
    ...
    c2->SaveAs(Form("pp500_BEMC_Mass_narrow_12_pT.pdf"));
    c2->Close();
...
// Signal narrow window p_T 2-3 GeV-----------------------------------------------------------------------------------------------------------------------------
    ...
    *r3 = 10*(*diff3);
    ...
    s3->GetYaxis()->SetRangeUser(0,80000);
    ...
    c3->SaveAs(Form("pp500_BEMC_Mass_narrow_23_pT.pdf"));
    c3->Close();
...
// Signal narrow window p_T 3-4 GeV-----------------------------------------------------------------------------------------------------------------------------
    ...
    *r4 = 5*(*diff4);
    ...
    s4->GetYaxis()->SetRangeUser(0,20000);
    ...
    c4->SaveAs(Form("pp500_BEMC_Mass_narrow_34_pT.pdf"));
    c4->Close();
...
// Signal narrow window p_T >4 GeV-----------------------------------------------------------------------------------------------------------------------------
    ...
    *r5 = 5*(*diff5);
    ...
    s5->GetYaxis()->SetRangeUser(0,12000);
    ...
    c5->SaveAs(Form("pp500_BEMC_Mass_narrow_45_pT.pdf"));
    c5->Close();
...
//    l6->AddEntry((TObject*)0, "#it{p}_{T}(K#pi) > 4 GeV/#it{c}^{2}", "");
 ...
 //   s6->GetYaxis()->SetRangeUser(0,370000);
    ...
    c6->SaveAs(Form("pp500_BEMC_Mass_wide_all_pT.pdf"));
    c6->Close();
...
//    s7->GetYaxis()->SetRangeUser(0,250000);
    ...
    c7->SaveAs(Form("pp500_BEMC_Mass_wide_12_pT.pdf"));
    c7->Close();
...
//    s8->GetYaxis()->SetRangeUser(0,100000);
    ...
    c8->SaveAs(Form("pp500_BEMC_Mass_wide_23_pT.pdf"));
    c8->Close();
...
//    s9->GetYaxis()->SetRangeUser(0,50000);
    ...
    c9->SaveAs(Form("pp500_BEMC_Mass_wide_34_pT.pdf"));
    c9->Close();
...
//    s10->GetYaxis()->SetRangeUser(0,50000);
    ...
    c10->SaveAs(Form("pp500_BEMC_Mass_wide_45_pT.pdf"));
    c10->Close();
...
// Dstar all p_T -----------------------------------------------------------------------------------------------------------------------------
    ...
    *b11 = 0.33333333333333333333333333333333*(*back11);
    ...
    Double_t bin = s11->GetBinWidth(1);

    TF1 *gauss1 = new TF1("gauss1","[0]*exp(-(x-[1])^2/(2*[2]^2))",0.143,0.148);
    gauss1->SetParameters(50,0.145,0.003);
    gauss1->SetParLimits(1,0.143,0.1455);
    gauss1->SetParLimits(2,0.0005,0.0007);

    r11->Fit("gauss1");
    gauss1->SetLineWidth(1);
    gauss1->Draw("same");


    Double_t chi2   = gauss1->GetChisquare(); // to retrieve the fit chi2
    Double_t mean = gauss1->GetParameter(1);
    Double_t meanerr = gauss1->GetParError(1);
    Double_t sigma = gauss1->GetParameter(2);
    Double_t sigmaerr = gauss1->GetParError(2);
    Double_t yield = (gauss1->Integral(0.143,0.148))/bin;
    Double_t yielderr = (gauss1->IntegralError(0.143,0.148))/bin;


    TLegend *lgauss1 = new TLegend(0.55,0.45, 0.85, 0.6,"","brNDC");
    lgauss1->AddEntry(gauss1, "Gauss", "pl");
    lgauss1->AddEntry((TObject*)0,Form("Mean = %f #pm %f",mean,meanerr), "");
    lgauss1->AddEntry((TObject*)0,Form("Sigma = %f #pm %f",sigma,sigmaerr), "");
    lgauss1->AddEntry((TObject*)0,Form("#chi^{2} = %f",chi2), "");
    lgauss1->AddEntry((TObject*)0,"Yield = 375 #pm 55", "");
    lgauss1->SetFillStyle(0);
    lgauss1->SetLineColor(0);
    lgauss1->SetTextSize(0.03);
    lgauss1->Draw("same");
    ...
    l11->AddEntry(b11, "Wrong-sign K^{#pm}#pi^{#pm}^{#pm} triplets (background)", "pl");
    ...
    s11->GetYaxis()->SetRangeUser(-50,1000);
    ...
    c11->SaveAs(Form("pp500_BEMC_Mass_Dstar-D0_all_pT.pdf"));
    c11->Close();
...
// Dstar all p_T 2-3 GeV ----------------------------------------------------------------------------------------------------------------------------
    ...
    *b12 = 0.33333333333333333333333333333333*(*back12);
    ...
    Double_t bin23 = s12->GetBinWidth(1);

    TF1 *gauss2 = new TF1("gauss2","[0]*exp(-(x-[1])^2/(2*[2]^2))",0.143,0.148);
    gauss2->SetParameters(50,0.145,0.003);
    gauss2->SetParLimits(1,0.144,0.146);
    gauss2->SetParLimits(2,0.0005,0.0007);

    r12->Fit("gauss2");
    gauss2->SetLineWidth(1);
    gauss2->Draw("same");


    Double_t chi223   = gauss2->GetChisquare(); // to retrieve the fit chi2
    Double_t mean23 = gauss2->GetParameter(1);
    Double_t meanerr23 = gauss2->GetParError(1);
    Double_t sigma23 = gauss2->GetParameter(2);
    Double_t sigmaerr23 = gauss2->GetParError(2);
    Double_t yield23 = (gauss2->Integral(0.143,0.148))/bin23;
    Double_t yielderr23 = (gauss2->IntegralError(0.143,0.148))/bin23;


    TLegend *lgauss2 = new TLegend(0.55,0.45, 0.85, 0.6,"","brNDC");
    lgauss2->AddEntry(gauss2, "Gauss", "pl");
    lgauss2->AddEntry((TObject*)0,Form("Mean = %f #pm %f",mean23,meanerr23), "");
    lgauss2->AddEntry((TObject*)0,Form("Sigma = %f #pm %f",sigma23,sigmaerr23), "");
    lgauss2->AddEntry((TObject*)0,Form("#chi^{2} = %f",chi223), "");
    lgauss2->AddEntry((TObject*)0,"Yield = 178 #pm 95", "");
    lgauss2->SetFillStyle(0);
    lgauss2->SetLineColor(0);
    lgauss2->SetTextSize(0.03);
    lgauss2->Draw("same");
    ...
    s12->GetYaxis()->SetRangeUser(-50,700);
    ...
    c12->SaveAs(Form("pp500_BEMC_Mass_Dstar-D0_23_pT.pdf"));
    c12->Close();
...
// Dstar all p_T 3-4 GeV ----------------------------------------------------------------------------------------------------------------------------
    ...
    *b13 = 0.33333333333333333333333333333333*(*back13);
    ...
    s13->GetYaxis()->SetRangeUser(-50,300);
    ...
    c13->SaveAs(Form("pp500_BEMC_Mass_Dstar-D0_34_pT.pdf"));
    c13->Close();
...
// Dstar all p_T >4 GeV ----------------------------------------------------------------------------------------------------------------------------
    ...
    *b14 = 0.33333333333333333333333333333333*(*back14);
    ...
    s14->GetYaxis()->SetRangeUser(-50,130);
    ...
    c14->SaveAs(Form("pp500_BEMC_Mass_Dstar-D0_45_pT.pdf"));
    c14->Close();
...
// Dstar all p_T backFit-----------------------------------------------------------------------------------------------------------------------------
    TH1F* s15 = (TH1F*) d2 -> Get("Dstar-D0;1");
    TH1F* back15 = (TH1F*) d2 -> Get("bDstar-D0;1");
    TH1F* diff15 = (TH1F*) d2 -> Get("Dstar-D0 rozdil;1");

    TCanvas *c15 = new TCanvas("c15", "Invariant mass", 1400, 1000);

    TH1F *r15 = new TH1F();
    *r15 = 1*(*diff15);

    TH1F *b15 = new TH1F();
    *b15 = 0.33333333333333333333333333333333*(*back15);
    ...
    TF1 *fq = new TF1("fq",fquadratic,0.14,0.16,3);
    reject = kTRUE;
    b15->Fit(fq,"0");
    ...
    TF1 *quadratic1 = new TF1("quadratic1","[0]+[1]*x+[2]*x*x",0.14,0.16);
    quadratic1->FixParameter(0,AAA);
    quadratic1->FixParameter(1,BBB);
    quadratic1->FixParameter(2,CCC);


    quadratic1->SetLineWidth(1);
    quadratic1->Draw("same");

    TF1 *turbofunkce = new TF1("turbofunkce", "([0]+[1]*x+[2]*x*x)+([4]*exp(-(x-[5])^2/(2*[6]^2)))" ,0.14, 0.16);
    turbofunkce->FixParameter(0,AAA);
    turbofunkce->FixParameter(1,BBB);
    turbofunkce->FixParameter(2,CCC);
    turbofunkce->SetParameter(4,50);
    turbofunkce->SetParameter(5,0.145);
    turbofunkce->SetParameter(6,0.003);


    s15->Fit("turbofunkce");
    turbofunkce->SetLineWidth(1);
    turbofunkce->SetLineColor(kBlue);
    turbofunkce->Draw("same");


    s15->SetMarkerStyle(22);
    b15->SetMarkerStyle(23);
    r15->SetMarkerStyle(33);

    s15->SetMarkerSize(1.2);
    b15->SetMarkerSize(1.2);
    r15->SetMarkerSize(1.8);

    s15->SetMarkerColor(kBlue);
    b15->SetMarkerColor(kRed);
    r15->SetMarkerColor(kBlack);

    s15->SetTitle(" ; ");
    s15->SetStats(0);

    TLegend *l15 = new TLegend(0.15,0.69, 0.35, 0.89,"","brNDC");
    l15->AddEntry(s15, "Correct-sign K^{#pm}#pi^{#mp}#pi^{#mp} triplets", "pl");
    l15->AddEntry(b15, "Wrong-sign K^{#pm}#pi^{#pm}^{#pm} triplets (background)", "pl");
    l15->AddEntry(r15, "Difference US-LS", "pl");
    l15->AddEntry((TObject*)0, "", "");
    l15->AddEntry((TObject*)0, "THIS THESIS", "");
    l15->AddEntry((TObject*)0, "p+p #sqrt{#it{s}} = 510 GeV", "");

    l15->SetFillStyle(0);
    l15->SetLineColor(0);
    l15->SetTextSize(0.03);
    l15->Draw("same");

    s15->GetYaxis()->SetTitle("Counts [-]");
    s15->GetYaxis()->SetTitleOffset(1.);
    s15->GetYaxis()->SetLabelSize(0.03);
    s15->GetYaxis()->SetTitleSize(0.04);
    s15->GetYaxis()->SetLabelFont(42);
    s15->GetYaxis()->SetTitleFont(42);
    s15->GetYaxis()->SetRangeUser(-50,1000);
    s15->GetYaxis()->CenterTitle(kTRUE);
    s15->GetXaxis()->SetTitle("#it{M}_{K#pi#pi}-#it{M}_{K#pi} [GeV/#it{c}^{2}]");
    s15->GetXaxis()->SetLabelFont(42);
    s15->GetXaxis()->SetTitleFont(42);
    //  s1->GetXaxis()->SetRangeUser(0,6);
    s15->GetXaxis()->SetTitleSize(0.04);
    s15->GetXaxis()->SetLabelSize(0.03);
    s15->GetXaxis()->CenterTitle(kTRUE);
    c15->SaveAs(Form("pp500_BEMC_backFit_Mass_Dstar-D0_all_pT.pdf"));
    c15->Close();

// Dstar all p_T 2-3 GeV backFit----------------------------------------------------------------------------------------------------------------------------
    TH1F* s16 = (TH1F*) d2 -> Get("Dstar-D0 S23;1");
    TH1F* back16 = (TH1F*) d2 -> Get("bDstar-D0 B23;1");
    TH1F* diff16 = (TH1F*) d2 -> Get("Dstar-D0 rozdil23;1");

    TCanvas *c16 = new TCanvas("c16", "Invariant mass", 1400, 1000);

    TH1F *r16 = new TH1F();
    *r16 = 1*(*diff16);

    TH1F *b16 = new TH1F();
    *b16 = 0.33333333333333333333333333333333*(*back16);
    ...
    s16->SetMarkerStyle(22);
    b16->SetMarkerStyle(23);
    r16->SetMarkerStyle(33);

    s16->SetMarkerSize(1.2);
    b16->SetMarkerSize(1.2);
    r16->SetMarkerSize(1.8);

    s16->SetMarkerColor(kBlue);
    b16->SetMarkerColor(kRed);
    r16->SetMarkerColor(kBlack);

    s16->SetTitle(" ; ");
    s16->SetStats(0);

    TLegend *l16 = new TLegend(0.15,0.69, 0.35, 0.89,"","brNDC");
    l16->AddEntry(s16, "Correct-sign K^{#pm}#pi^{#mp}#pi^{#mp} triplets", "pl");
    l16->AddEntry(b16, "Wrong-sign K^{#pm}#pi^{#pm}#pi^{#pm} triplets (background)", "pl");
    l16->AddEntry(r16, "Difference US-LS", "pl");
    l16->AddEntry((TObject*)0, "", "");
    l16->AddEntry((TObject*)0, "THIS THESIS", "");
    l16->AddEntry((TObject*)0, "p+p #sqrt{#it{s}} = 510 GeV", "");
    l16->AddEntry((TObject*)0, "2 < #it{p}_{T}(K#pi#pi) < 3 GeV/#it{c}^{2}", "");

    l16->SetFillStyle(0);
    l16->SetLineColor(0);
    l16->SetTextSize(0.03);
    l16->Draw("same");

    s16->GetYaxis()->SetTitle("Counts [-]");
    s16->GetYaxis()->SetTitleOffset(1.);
    s16->GetYaxis()->SetLabelSize(0.03);
    s16->GetYaxis()->SetTitleSize(0.04);
    s16->GetYaxis()->SetLabelFont(42);
    s16->GetYaxis()->SetTitleFont(42);
    s16->GetYaxis()->SetRangeUser(-50,700);
    s16->GetYaxis()->CenterTitle(kTRUE);
    s16->GetXaxis()->SetTitle("#it{M}_{K#pi#pi}-#it{M}_{K#pi} [GeV/#it{c}^{2}]");
    s16->GetXaxis()->SetLabelFont(42);
    s16->GetXaxis()->SetTitleFont(42);
    //  s1->GetXaxis()->SetRangeUser(0,6);
    s16->GetXaxis()->SetTitleSize(0.04);
    s16->GetXaxis()->SetLabelSize(0.03);
    s16->GetXaxis()->CenterTitle(kTRUE);
    c16->SaveAs(Form("pp500_BEMC_backFit_Mass_Dstar-D0_23_pT.pdf"));
    c16->Close();
