...
//	gStyle->SetOptFit(0);
  ...
  cout<<"Rotated momentum scale factor: "<<Scalefactor<<endl;
	...
	Unlike->GetYaxis()->SetTitle("Entries (/0.02 GeV/c^{2})");
...
//	}
	...
	fSignalLike->SetParLimits(6,0.007,0.0260);////0.0260
...
//	}
	...
	fSignalRotate->SetParLimits(6,0.007,0.0260);
...
//	fSignalRotate->FixParameter(0,par[0]);
	...
	fSignalMixed->SetParLimits(6,0.007,0.0260);
...
//	resultsLegend->Draw();
	...
	likeClon->GetYaxis()->SetRangeUser(-1500,6500);
	likeClon->GetYaxis()->SetTitle("Entries (/0.02 GeV/c^{2})");
	...
	rotClon->GetYaxis()->SetRangeUser(-1500,6500);
	rotClon->GetYaxis()->SetTitle("Entries (/0.02 GeV/c^{2})");
...
//	gPad->SetLeftMargin(0.15);
	...
	mixClon->GetYaxis()->SetTitle("Entries (/0.02 GeV/c^{2})");
