#include <limits>
#include <cmath>
#include "StHFRotPair.h"
#include "StPicoEvent/StPicoPhysicalHelix.h"
#include "StarClassLibrary/SystemOfUnits.h"
#include "StPicoEvent/StPicoTrack.h"
#include "StTypeDefs.h"

ClassImp(StHFRotPair)

// _________________________________________________________
StHFRotPair::StHFRotPair(): mLorentzVector(TLorentzVector()), mDecayVertex(TVector3()),
...
// _________________________________________________________
StHFRotPair::StHFRotPair(StHFRotPair const * t) : mLorentzVector(t->mLorentzVector), mDecayVertex(t->mDecayVertex),
...
// _________________________________________________________
StHFRotPair::~StHFRotPair() {
    // destructor

}

// _________________________________________________________
StHFRotPair::StHFRotPair(StPicoTrack const * const particle1, StPicoTrack const * const particle2,
...
//  pair<double, double> const ss = (useStraightLine) ? p1StraightLine.pathLengths(p2StraightLine) : p1Helix.pathLengths(p2Helix);
  ...
  TVector3 const p2MomAtDca = -1*(p2Helix.momentumAt(ss.second, bField * kilogauss));
...
// _________________________________________________________
float StHFRotPair::pointingAngle(TVector3 const & vtx2) const{
...
// _________________________________________________________
float StHFRotPair::decayLength(TVector3 const & vtx2) const{
...
// _________________________________________________________
float StHFRotPair::particle1Dca(StPicoTrack const * p1track, TVector3 const & vtx2, float const bField) const{
...
// _________________________________________________________
float StHFRotPair::particle2Dca(StPicoTrack const * p2track, TVector3 const & vtx2, float const bField) const{
  // -- Overloaded function recalculates daughter dca 2 updated vertex
