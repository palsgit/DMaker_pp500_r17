#!/bin/bash
cd workDir
productionId=`date +%F_%H-%M`_D0_test
analyzer="palsp"
...
mkdir starSubmit
cp ../../starSubmit/submitPicoHFMaker_test.xml ./starSubmit
...
star-submit-template -template ./starSubmit/submitPicoHFMaker_test.xml -entities basePath=${baseFolder},prodId=${productionId},rootMacro=${rootMacro}